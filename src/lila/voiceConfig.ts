...
export const LILA_PITCH_CONFIG = {
  ...
  presets: [
    ...
    { label: 'Sweet Young Girl ⭐', value: 1.10, tag: 'Signature' },
...
export const getPitchDescription = (pitch: number): string => {
  ...
  if (pitch <= 1.12) return 'Signature sweet young girl tone (Lila)';
...
export const LILA_ACOUSTIC_PRESETS = {
  ...
  speechSynthesisPitch: 1.18, // Sweet youthful pitch for Web Speech fallback
